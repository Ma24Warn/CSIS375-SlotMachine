...
public class slots {
    ...
    public static void main(String args[]) {
        ...
        while (coins > 0) {
            ...
            else if ((wheel1 == 3 && wheel2 == 3 && wheel3 != 3) || (wheel1 == 3 && wheel2 != 3 && wheel3 == 3) || (wheel1 != 3 && wheel2 == 3 && wheel3 == 3)) {
                coins += 2;
                //System.out.println("Wheel1: " + wheel1 + " Wheel2: " + wheel2 + " Wheel3: " + wheel3);
            }

            //a cherry, a non-cherry, and anything
            else if ((wheel1 == 3 && wheel2 != 3) || (wheel1 == 3 && wheel3 != 3) || (wheel2 == 3 && wheel1 != 3) || (wheel2 == 3 && wheel3 != 3) || (wheel3 == 3 && wheel1 != 3) || (wheel2 == 3 && wheel3 != 3) || (wheel3 == 3 && wheel2 != 3)) {
                coins += 1;
                //System.out.println("Wheel1: " + wheel1 + " Wheel2: " + wheel2 + " Wheel3: " + wheel3);
            }
